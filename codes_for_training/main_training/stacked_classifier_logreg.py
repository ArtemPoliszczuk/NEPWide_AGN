...
#----------------- Data: --------------------
train_path = "stacked_classifier_training_sample_akari_nep_wide.csv"
general_path = "stacked_classifier_generalization_sample_akari_nep_wide.csv"
...
info_columns = ['AKR_ID','HSC-ID', 'k12id', 'sep', 'id_spz', 'specz', 'q', 'clss']
